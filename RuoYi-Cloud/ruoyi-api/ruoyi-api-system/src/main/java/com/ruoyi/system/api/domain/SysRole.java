...
public class SysRole extends BaseEntity
{
    ...
    /** data range（1：所有数据权限；2：自定义数据权限；3：本部门数据权限；4：本部门及以下数据权限；5：仅本人数据权限） */
    @Excel(name = "data range", readConverterExp = "1=All data permissions, 2=Customized data permissions, 3=This department’s data permissions, 4=This department and below data permissions, 5=Only my own data permissions")
    ...
    @NotBlank(message = "Role Name不能为空")
    @Size(min = 0, max = 30, message = "Role Name长度不能超过30个字符")
