...
public class SysUserController extends BaseController
{
    ...
    public R<LoginUser> info(@PathVariable("username") String username)
    {
        ...
        {
            return R.fail("wrong user name or password");
        }
        // 角色集合
    ...
    public R<Boolean> register(@RequestBody SysUser sysUser)
    {
        ...
        {
            return R.fail("The registration function is not currently enabled in the system!");
        }
        if (!userService.checkUserNameUnique(sysUser))
        {
            return R.fail("Save user'" + username + "'Failed, the registered account already exists");
        }
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        ...
        {
            return error("New users'" + user.getUserName() + "'Failed, the mobile phone number already exists");
        }
        else if (StringUtils.isNotEmpty(user.getEmail()) && !userService.checkEmailUnique(user))
        {
            return error("New users'" + user.getUserName() + "'Failed, the email account already exists");
        }
    ...
    public AjaxResult edit(@Validated @RequestBody SysUser user)
    {
        ...
        {
            return error("Modify user'" + user.getUserName() + "'Failed, the mobile phone number already exists");
        }
        else if (StringUtils.isNotEmpty(user.getEmail()) && !userService.checkEmailUnique(user))
        {
            return error("Modify user'" + user.getUserName() + "'Failed, the email account already exists");
        }
